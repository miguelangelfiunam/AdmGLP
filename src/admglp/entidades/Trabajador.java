...
public class Trabajador extends Persona {
    ...
    public Trabajador(int numeroTrabajador, int numeroSeguro, String rfcTrabajador, Date fechaRegistro, Date fechaActualizacion, String tipoTrabajador, Transporte transporte, Turno turno, int estadoTrabajador) {
    ...
    public Trabajador(int numeroTrabajador, int numeroSeguro, String rfcTrabajador, Date fechaRegistro, Date fechaActualizacion, String tipoTrabajador, Transporte transporte, Turno turno, int estadoTrabajador, String nombre, String apellido1, String apellido2, int edad, Date fechaNacimiento) {
    ...
    public Trabajador(int numeroTrabajador, int numeroSeguro, String rfcTrabajador, Date fechaRegistro, Date fechaActualizacion, String tipoTrabajador, Transporte transporte, Turno turno, int estadoTrabajador, String nombre, String apellido1, String apellido2, int edad, Date fechaNacimiento, int idUsuario, String correo, boolean acceso, Date fecInicioAcceso, Date fecFinAcceso, int estadoUsuario) {
